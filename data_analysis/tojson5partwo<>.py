...
for num_P in range(len(PATH_list)): 
    ...
    row_tp = []
    with open('result/'+result_path+'/'+'5_part_wo<>2_'+result_path+".csv", 'r') as f:
        ...
        with open("data/test/output.csv", 'rb') as f:
            result = chardet.detect(f.read())
            print(result['encoding'])
        with codecs.open("data/test/output.csv", 'r',encoding = 'gb18030' ) as f:
            # 创建CSV读取器
            reader = csv.reader(f)
    ...
    with open(PATH, 'r') as f:
        ...
        for c in range(1,4):
            ...
            with open('result/'+result_path+'/5_part_wo<>2_'+result_path+'.json','w') as f2:
                for data in x:
            ...
            try:
                ...
                with open('result/'+result_path+'/'+'5_part_wo<>2_reslut.txt', way) as f:
                    f.write('relation:{}\n'.format(c))
                ...
                with open('result/'+result_path+'/'+'5_part_wo<>2_reslut.txt', 'w') as f:
                    f.write('relation:{}\n'.format(c))
                    f.write("true_labels:{}\n,true:false={}:{}\n".format(true_labels,true_labels.count(1),true_labels.count(0)))
                    f.write("pred_labels:{}\n,true:false:unclear={}:{}:{}\n".format(pred_labels,pred_labels.count(1),pred_labels.count(0),pred_labels.count(2)))
                    f.write("unclear_labels:{}\n".format(num))
