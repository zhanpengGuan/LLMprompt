...
+"腐”=“豆腐乳”。“豆腐乳”>“南乳”。“乳腐”=“豆腐乳”。“霉豆腐”=“腐乳”。“腐乳”=“乳腐”。“腐乳”=“豆腐乳”。请问“霉豆腐”是否>“南乳”？}Output1:{是}。Output2:{因为(霉豆腐,=,豆腐乳)，(豆腐乳,>,南乳),因此(霉豆腐,>，南乳)成立。}"
            x1.append(prompt)

    # 打开CSV文件并写入数据
    result_path = PATH.split('.')[0]

    with open('result/'+result_path+'/'+'5_part_ltm_'+result_path+".csv", 'w', newline='', encoding='utf-8') as file:
